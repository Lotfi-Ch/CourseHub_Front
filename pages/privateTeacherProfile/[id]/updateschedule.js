...
export const getStaticProps = async (context) => {
  ...
  const teacher = await fetch(
    `${process.env.NEXT_PUBLIC_SERVER}/admin/teacher/one/${teacherId}`
  );
...
const UpdateSchedule = ({ teacherId }) => {
  ...
  let changeSchedule = () => {
    let updateDays = axios
      .post(`${process.env.NEXT_PUBLIC_SERVER}/teacher/days/${teacherId}`, {
        monday,
        tuesday,
        wednesday,
        thursday,
    ...
    let updateSessions = axios
      .post(`${process.env.NEXT_PUBLIC_SERVER}/teacher/sessions/${teacherId}`, {
        one,
        two,
        three,
        four,
